...
(function () {
  ...
  $(function () {
    ...
    if (plugins.captcha.length) {
      $.getScript(
        "../www.google.com/recaptcha/api43e2.js?onload=onloadCaptchaCallback&amp;render=explicit&amp;hl=en"
      );
    }
      ...
      for (var i = 0; i < plugins.swiper.length; i++) {
        var sliderMarkup = plugins.swiper[i],
          ...
          options = {
            ...
            effect: isIE
              ? "slide"
              : sliderMarkup.getAttribute("data-effect") || "slide",
            direction:
        ...
        $form.attr("novalidate", "novalidate").ajaxForm({
                ...
                $.ajax({
                  ...
                  if (responceCode !== "CPT000") {
                    if (output.hasClass("snackbars")) {
                      output.html(
                        '<p><span class="icon text-middle fa-check icon-xxs"></span><span>' +
          ...
          success: function (result) {
            ...
            if (result === "MF000") {
              ...
              if (output.hasClass("snackbars")) {
                output.html(
                  ' <p class="snackbars-left"><span class="icon icon-xxs fa-exclamation-triangle text-middle"></span><span>' +
                    msg[result] +
                    "</span></p>"
                );
              } else {
